...
return Library
--[[
Decided to make this open sourced so here are some docs for you my friend!

WindowYSize=545
WindowTheme=Color3.fromRGB(23, 121, 207)
Window=Library:Window("Window", WindowTheme, WindowYSize)
Tab=Window:Tab("Tab")
Section=Tab:Section("Section")

Window:Label("yesok#3877", Color3.fromRGB(150, 150, 150))

Section:Toggle("Toggle", function(bool)
    print(bool)
end)
...
Max=100
Min=10
Section:ToggleSlider("Toggle Slider", Max, Min, function(bool, value)
    print(bool, value)
end)
Section:Slider("Slider", Max, Min, function(value) 
    print(value)
end)
Section:Keybind("Keybind 1", function(bool)
    print(bool)
end)
Section:Keybind("Keybind 2", function(bool)
    print(bool)
end)
Section:Textbox("Textbox", function(string)
    if string ~= '' then
        print(string)
    end
end)
Section:Color("Color", function(color)
    print(color)
end)
